...
fun ItemEditScreen(
    ...
    // Obtener la lista de URIs de multimedia del ViewModel
    ...
    Scaffold(
        ...
        modifier = modifier.fillMaxSize() // Ajuste para que Scaffold ocupe todo el tamaño de la pantalla
    ) { innerPadding ->
        Column(
            modifier = Modifier
                .padding(
                ...
                .verticalScroll(rememberScrollState()).background(MaterialTheme.colorScheme.secondary)
                .fillMaxSize()  // Hacer que el contenedor principal ocupe toda la pantalla disponible
        ) {
            // Mostrar la sección de entrada de datos
            ItemEntryBody(
                itemUiState = uiState,
            ...
            // Mostrar la sección de multimedia
            MultimediaSection(
                title = "Fotos",
                uris = uiState.itemDetails.photoUris
            )
            MultimediaSection(
                title = "Videos",
                uris = uiState.itemDetails.videoUris
            )
            MultimediaSection(
                title = "Audios",
                uris = uiState.itemDetails.audioUris
            )
        }
    }
}
